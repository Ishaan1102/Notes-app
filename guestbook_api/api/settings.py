...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'ec2-3-17-165-191.us-east-2.compute.amazonaws.com']
...
STATIC_URL = f'http://{AWS_STORAGE_BUCKET_NAME}.s3-website.us-east-2.amazonaws.com/'
...
# HSTS is recommended when SSL is used
